...
A creature can use its action to inspect a target and make an [[Investigation|Intelligence (Investigation)]] check against your spell save DC. If it succeeds, it becomes aware that the target is disguised.
