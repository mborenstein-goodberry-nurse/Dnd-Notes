...
**Eyes of the Dead**. You can use an [[action]] to name a place the humanoid saw in life, which creates an invisible sensor somewhere in that place if it is on the plane of existence you’re currently on. The sensor remains for as long as you [[Concentration|concentrate]], **up to 10 minutes** (as if you were [[Concentration|concentrating]] on a spell). You receive visual and auditory information from the sensor as if you were in its space using your senses.
