...
When you reach 3rd level in this class, you learn the _[[darkness]]_ spell, which doesn't count against your number of sorcerer spells known. In addition, you can cast it by spending 2 sorcery points or by expending a spell slot. If you cast it with sorcery points, you can see through the darkness created by the spell.
...
The hound appears in an unoccupied space of your choice within **30 feet** of the target. Roll [[initiative]] for the hound. On its turn, it can move only toward its target by the most direct route, and it can use its [[action]] only to attack its target. The hound can make [[Opportunity Attack|Opportunity Attacks]], but only against its target. Additionally, while the hound is within **5 feet** of the target, the target has [[disadvantage]] on saving throws against any spell you cast. The hound disappears if it is reduced to 0 hit points, if its target is reduced to 0 hit points, or after **5 minutes**.
