...
As a [[bonus action]], you can choose an ally **you can see** within **120 feet of you** and spend a number of those dice equal to **half your druid level** or less. Roll the spent dice and add them together. The target regains a number of [[hit points]] equal to the total. The target also gains **1 [[Temporary Hit Points|temporary hit point]] per die** spent.

You regain the expended dice when you finish a [[long rest]].

### Hearth of Moonlight and Shadow

At 6th level, home can be wherever you are. During a [[Short Rest|short]] or [[long rest]], you can invoke the shadowy power of the Gloaming Court to help guard your respite. At the start of the rest, you touch a point in space, and an invisible, **30-foot-radius sphere** of magic appears, centered on that point. Total cover blocks the sphere.

While within the sphere, you and your allies gain a +5 bonus to [[Stealth|Dexterity (Stealth)]] and [[Perception|Wisdom (Perception)]] checks, and any light from open flames in the sphere (a campfire, torches, or the like) isn't visible outside it.
