...
Starting at 2nd level, you can use your Channel Divinity to make your very presence a soothing balm. As an [[action]], you can move up to your speed, **without** provoking [[opportunity attack|opportunity attacks]], and when you move within 5 feet of any other creature during this action, you can restore a number of hit points to that creature equal to **2d6 + your [[Wisdom]] modifier** (minimum of 1 hit point). A creature can receive this healing only once whenever you take this action.
...
At 8th level, you add your [[Wisdom]] modifier to the damage you deal with any [[Cleric Spells#Cantrip|cleric cantrip]].
