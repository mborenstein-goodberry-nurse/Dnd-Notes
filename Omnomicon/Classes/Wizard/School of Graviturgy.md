...
While the weight of a creature is halved by this effect, the creature's **speed** increases by **10 feet**, it can jump twice as far as normal, and it has [[disadvantage]] on [[Strength#Skills|Strength checks]] and **[[Strength]] saving throws**.

While the weight of a creature is doubled by this effect, the creature's speed is reduced by **10 feet**, and it has [[advantage]] on [[Strength#Skills|Strength checks]] and **[[Strength]] saving throws**.
