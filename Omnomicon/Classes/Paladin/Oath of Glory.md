...
- **_Peerless Athlete._** As a [[bonus action]], you can use your Channel Divinity to augment your athleticism. For the next 10 minutes, you have [[advantage]] on [[Athletics|Strength (Athletics)]] and [[Acrobatics|Dexterity (Acrobatics)]] checks; you can carry, push, drag, and lift twice as much weight as normal; and the distance of your long and high [[Jumping|Jumps]] increases by **10 feet** (this extra distance costs movement as normal).
...
- You are blessed with an otherworldly presence, gaining [[advantage]] on all [[Charisma#Skills|Charisma checks]].
